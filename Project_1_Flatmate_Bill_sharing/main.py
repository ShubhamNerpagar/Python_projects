...
class Bill:
    ...
    Object that contain data about bill, such as total amount and period of the bill
    """
...
the_bill = Bill(120, "April 2024")
Rahul = Flatmate('Rahul', 23)
vishal = Flatmate('Vishal', 29)

print("Rahul Pays: ",Rahul.pays(the_bill, vishal))
print("Vishal Pays:", vishal.pays(the_bill, Rahul))


pdf_report = PdfReport(filename="Report1.pdf")
pdf_report.generate(flatmate1=Rahul, flatmate2=vishal,bill=the_bill)